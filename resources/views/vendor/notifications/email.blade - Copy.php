...
<body>
    <div class="main-container">
        ...
        <center>
            <p>
                <a class="button" style="color:white" href="#">Complete Registration</a>
            </p>
...
{{ $salutation }}
@else
@lang('Regards'),<br>{{ 'Moray Limousines' }}
@endif
...
@lang(
"If you’re having trouble clicking the \":actionText\" button, copy and paste the URL obaid below\n".
