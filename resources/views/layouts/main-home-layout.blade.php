            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-6 text-center ft2">
                    <div class="widget-footer widget-services">
                        ...
                        <ul>
                            @foreach(\App\CmsService::all()->take(4) as $service)
                                <li>
                ...
                <div class="col-md-2 col-sm-6 col-xs-6 text-center ft1">
                    <div class="widget-footer newletter">
                        ...
                        {{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_PHONE_NUMBER) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_PHONE_NUMBER) : '+49 (0) 69 330 889 08'}}
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="city">
                        @foreach(\App\Location::all()->where('is_top_city',true) as $city)
                            <li>
