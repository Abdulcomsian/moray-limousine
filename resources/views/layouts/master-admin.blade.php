...
{{--            <li class="nav-item"><a href="#" class="nav-link"><i class="icon-chart"></i></a></li>--}}
            ...
            <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
              <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <img class="img-xs rounded-circle ml-2" src="{{asset('images/logo-new.png') }}"
                     alt="Profile image"> <span class="font-weight-normal"> {{Auth()->user()->first_name}} {{Auth()->user()->last_name}} </span></a>
...
{{--                  <li class="nav-item"> <a class="nav-link" href="{{url('admin/add-vehicle')}}">Add new Vehicle</a></li>--}}
...
{{--                  </a></li>--}}
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                  <a class="nav-link" data-toggle="collapse" href="#manageDesign" aria-expanded="false"
