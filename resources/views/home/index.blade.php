            ...
            <div id="rev_slider_1078_2" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
                ...
                <ul><!-- SLIDE  -->
                    ...
                    <li data-index="rs-3049" data-transition="slideremovedown" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="2000"    data-rotate="0"  data-saveperformance="off"  data-title="Ken Burns" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_SLIDER_IMAGE) ? asset(\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_SLIDER_IMAGE)) : asset('images/slider/home04.jpg')}}"  alt=""  data-bgposition="center center" data-kenburns="off" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        <div class="tp-caption title ff-2 theme-color text-capitalize"
                             ...
                             style="z-index: 16;  white-space: nowrap;font-weight: 500; font-size: 2rem !important;;">{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_SLIDER_IMAGE_TEXT) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_SLIDER_IMAGE_TEXT) : 'Book Your Own Chauffeur Drive!'}}
                    ...
                    <li data-index="rs-3050" data-transition="slideremovedown" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="2000"    data-rotate="0"  data-saveperformance="off"  data-title="Ken Burns" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        ...
                        <div class="tp-caption title ff-2 theme-color"
                             ...
                             data-paddingbottom="[0,0,0,0"
                             data-paddingleft="[0,0,0,0]"
                             style="z-index: 16; font-size: 2rem !important; white-space: nowrap;font-weight: 400;;">{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_SLIDER_IMAGE_TEXT) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_SLIDER_IMAGE_TEXT) : 'Book Your Own Chauffeur Drive!'}}
                        </div>
                    </li>
                    <li data-index="rs-3050" data-transition="slideremovedown" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="2000"    data-rotate="0"  data-saveperformance="off"  data-title="Ken Burns" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                    ...
                    <div class="sdl-booking add-box">
                        ...
                        <div id="bk-1" class="schedule-booking">
                            ...
                            <form class="form-booking" method="GET" action="{{route('get.booking')}}" validate="true">
                                ...
                                <div class="p-0">
                                    <h6 class="text-white">{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_TEXT_UNDER_PICK_TIME) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_TEXT_UNDER_PICK_TIME) : 'Free Waiting For 15 min'}}</h6>
{{--                                    <hr class="m-0">--}}
                                </div>
    ...
    <section class="block-fleet change_bg  mt-0">
        <div class="container">
            <div class="template-title has-over">
                <div class="container">
                    <h3 class="title">{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_FLEET_TITLE) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_FLEET_TITLE) : 'Our Fleet'}}</h3>
                </div>
            </div>
    ...
    <section class="template-title has-over text-up m-0 p-5" style="background-color: #d7d7d73d">
        <div class="container">
            <h3 class="title">{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_TITLE) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_TITLE) : 'Your Advantages'}}</h3>
            <p class="subtitle">{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_TITLE) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_DESCRIPTION) : 'Explore our first class limousine & car rental services'}}</p>
        </div>
    </section>
{{--    <!-- End Template title -->--}}
{{--    <!-- Start Section Iconbox -->--}}
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 size-table">
                    <div class="iconbox center">
                        <div class="iconbox-icon">
                            <img src="{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL1_IMAGE) ? asset(\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL1_IMAGE)) : asset('images/iconbox/001.png')}}" alt="">

                        </div>
                        <div class="iconbox-content">
                            <h3>
                                <span>{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL1_TITLE) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL1_TITLE) : 'Easy Online Booking'}}</span>
                            </h3>
                            <p>{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL1_DESCRIPTION) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL1_DESCRIPTION) : 'The most efficient booking system in this industry geared towards  handling single bookings to a full-fledged event'}} </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12 size-table">
                    <div class="iconbox center">
                        <div class="iconbox-icon">
                            <img src="{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL2_IMAGE) ? asset(\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL2_IMAGE)) : asset('images/iconbox/002.png')}}" style="max-width: 20%;" alt="">
                        </div>
                        <div class="iconbox-content">
                            <h3>
                                <span>{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL2_TITLE) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL2_TITLE) : 'Professional Drivers'}}</span>
                            </h3>
                            <p>{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL2_DESCRIPTION) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL2_DESCRIPTION) : 'Our professional drivers are licensed, insured and are required to comply with local laws and regulations. '}}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12 size-table">
                    <div class="iconbox center">
                        <div class="iconbox-icon">
                            <img src="{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL3_IMAGE) ? asset(\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL3_IMAGE)) : asset('images/iconbox/003.png')}}" alt="">
                        </div>
                        <div class="iconbox-content">
                            <h3>
                                <span>{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL3_TITLE) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL3_TITLE) : 'Guaranteed fixed prices'}}</span>
                            </h3>
                            <p>{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL3_DESCRIPTION) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL3_DESCRIPTION) : 'At Moray Limousines there are no hidden costs. Our prices include all fees, taxes and are guaranteed with the booking.'}}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12 size-table">
                    <div class="iconbox center">
                        <div class="iconbox-icon">
                            <img src="{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL4_IMAGE) ? asset(\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL4_IMAGE)) :asset('images/iconbox/004.png')}}" alt="">
                        </div>
                        <div class="iconbox-content">
                            <h3>
                                <span>{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL4_TITLE) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL4_TITLE) : 'Free waiting time'}}</span>
                            </h3>
                            <p>{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL4_DESCRIPTION) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL4_DESCRIPTION) : 'When picking up from the airport we wait 60 minutes for you. For all other pickups the free waiting time is 15 minutes'}} .</p>
                        </div>
                    </div>
                </div>
            </div>
          ...
          <div class="row justify-content-center">
              <div class="col-md-8 col-sm-12" style="background-color: #04040491; border-radius: 10px;">
                  <div class="wrapper-content">
                      <h3 class="title">
                          {{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ABOUT_US_TITLE) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ABOUT_US_TITLE) : 'ABOUT US'}}
                      </h3>
                      <div class="content">
                          <div class="col-md-12 col-sm-12">
                              <p>
                                  {{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ABOUT_US_TITLE) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ABOUT_US_DESCRIPTION) : 'We at Moray Limousines have set ourselves the goal of making premium travel on the road even more comfortable and luxurious. The well-being of our guests always comes first. We look forward to welcome you as a passenger on Borad!'}}
                              </p>
                          </div>
                      </div>
                      <dic class="contact">
                          <div class="col-md-12 col-sm-12">
                             ...
                             <div class="row justify-content-center">
                                  ...
                                  <span class="col-sm-12 col-md-3">{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_PHONE_NUMBER) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_PHONE_NUMBER) : "+49 (0) 69 330 889 08"}} </span>
                             </div>
                              </div>
                          </div>
                      </dic>
    ...
    <section class="template-title has-over text-up">
        <div class="container">
            <h3 class="title">{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_TITLE) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_TITLE) : 'Our Services'}}</h3>
            <p class="subtitle">{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_TITLE) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_DESCRIPTION) : 'Explore our first class limousine & car rental services'}}</p>
        </div>
    </section>
    <!-- End Template title -->
    <!-- Start Section Iconbox -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 col-md-offset-2  size-table">
                    <div class="iconbox center">
                        <div class="iconbox-icon">
                            <img src="{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_COL1_IMAGE) ? asset(\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_COL1_IMAGE)) : asset('images/icon/forma1.png')}}" alt="">
                        </div>
                        <div class="iconbox-content">
                            <h3>
                                <span>{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_COL1_TITLE) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_COL1_TITLE) : 'Limousine Service'}} </span>
                            </h3>
                            <p>{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_COL1_DESCRIPTION) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_COL1_DESCRIPTION) : 'We deal with the best world class limo\'s through Germany we have all the latest range of limo\'s And enjoy the title of first limo dealer in Germany.'}}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12 size-table">
                    <div class="iconbox center">
                        <div class="iconbox-icon">
                            <img src="{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_COL1_IMAGE) ? asset(\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_COL1_IMAGE)) : asset('images/icon/forma3.png')}}" alt="">
                        </div>
                        <div class="iconbox-content">
                            <h3>
                                <span>{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_COL2_TITLE) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_COL2_TITLE) : 'Airport Transfers'}}</span>
                            </h3>
                            <p>{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_COL2_DESCRIPTION) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_COL2_DESCRIPTION) : 'If you’re looking for the best in private airport transfers , look no further than Moray Lemousine . As  we know exactly what you need from a private transfer at Airports'}}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 size-table">
                    <div class="iconbox center">
                        <div class="iconbox-icon">
                            <img src="{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_COL1_IMAGE) ? asset(\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_COL1_IMAGE)) : asset('images/iconbox/004.png')}}" alt="">
                        </div>
                        <div class="iconbox-content">
                            <h3>
                                <span>{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_COL3_TITLE) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_COL3_TITLE) : 'Free waiting time'}}</span>
                            </h3>
                            <p>{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_COL3_DESCRIPTION) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_OUR_SERVICES_COL3_DESCRIPTION) : 'When picking up from the airport we wait 60 minutes for you. For all other pickups the free waiting time is 15 minutes.'}}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-4">
                    <div class="contact-item center">
                        ...
                        <div class="content-text">
                            <h4>Adresse</h4>
                            <p>{!! \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADDRESS) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADDRESS) : 'Moray Limousines (A brand of Moray Group UG) Friedrich-Ebert-Anlage 36 60325 Frankfurt am Main' !!}</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="contact-item center">
                        ...
                        <div class="content-text">
                            <h4>Telefon</h4>
                            <p> {{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_PHONE_NUMBER) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_PHONE_NUMBER) : '+49 (0) 69 330 889 08'}}</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="contact-item center">
                        ...
                        <div class="content-text">
                            <h4>Email</h4>
                            <p>{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_EMAIL_ADDRESS) ? \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_EMAIL_ADDRESS) : 'info@moray-limousines.com'}}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="urgentbook">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
		  ...
		  <p class="text-primary" style="color: #000000!important">Your selected time is less then 10 hours. </p>
