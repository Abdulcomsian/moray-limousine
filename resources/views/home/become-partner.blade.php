      ...
      <section class="info-box parallax parallax_one change_text">
        <div class="container">
            <div class="wrapper-content pt-4">
                ...
                <a href="" class="booking">Online Booking<img src="{{asset('images/icon/arrow-white.png')}}" alt=""></a>
            </div>
        </div>
    </section>
    <!-- End Info Box -->
            ...
            <div class="row justify-content-around" >
                    ...
                    <div class="iconbox center">
                        <div class="iconbox-icon">
                            <div style="opacity:1" class="style-jr50n2jm_comp-jr50pq1n style-jr50n2jm_non-scaling-stroke style-jr50n2jmsvg" id="comp-jr50pq1nsvg">
                                <svg preserveAspectRatio="xMidYMid meet" style="height: 5rem;" data-bbox="7.5 18.8 185.1 162.5" viewBox="7.5 18.8 185.1 162.5" xmlns="http://www.w3.org/2000/svg" data-type="color" role="img">
                                    <g>
                    ...
                    <div class="iconbox center">
                        <div class="iconbox-icon">
                            <div style="opacity:1" class="style-jr50n2jm_comp-jr50n29p style-jr50n2jm_non-scaling-stroke style-jr50n2jmsvg" id="comp-jr50n29psvg">
                                <svg preserveAspectRatio="xMidYMid meet" style="height: 5rem;" data-bbox="10.5 74.001 179 51.999" viewBox="10.5 74.001 179 51.999" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="color" role="img">
                                    <g>
                ...
                <div class="col-md-5 mt-4 col-sm-6 col-xs-12 size-table">
                    <div class="iconbox center mt-5">
                        <div class="iconbox-icon">
                            <img src="{{asset('images/iconbox/002.png')}}" style="max-width: 20%;" alt="">
                        </div>
                        <div class="iconbox-content">
                            <h3>
                ...
                <div class="col-md-5 mt-4 col-sm-6 col-xs-12 size-table">
                    <div class="iconbox center mt-5">
                        ...
                        <div class="iconbox-content">
                            ...
                            <p>Ihr Erfolg ist uns wichtig! Mit Moray Limousines können Sie Ihren Umsatz bequem steigern: Wir bieten unseren Partnern täglich Fahrten an, so dass sie ihre Standzeiten möglichst effizient nutzen können. Es liegt in Ihrer Hand, wie viel Sie verdienen möchten.
