                            ...
                            <div class="col-md-10 pr-0">
                                ...
                                <table class="table table-striped table-borderless ">
                                    ...
                                    <tbody>
                                        ...
                                        @else 
                                        <tr><td colspan="5">No Billing Information</td></tr>
                                        @endif
                                    </tbody>
                                </table>
                            </div>
                        ...
                        @if($booking->driver()->exists() && $booking->driver()->first()->user_type == 'driver')
                            <table class="table table-responsive-sm table-striped table-bordered">
                                ...
                                @foreach($booking->driver()->get() as $driver)
                                    <tr>
                                        <td>{{$counter++}}</td>
                                        <td><a href="{{route('admin.driverDetail', $driver->id)}}"
                                               target="_blank">{{$driver->userName()}}</a></td>
                        ...
                        @if($booking->vehicle()->exists())
                            <table class="table mt-3 table-responsive-sm table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{asset('/admin-vehicle-img/'.$booking->vehicle()->first()->image_name)}}"
                ...
                @if($booking->vehicle()->exists())
                    <table class="table mt-3 table-responsive-sm table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <td>{{$booking->vehicle()->first()->model_no}}</td>
                            <td><img src="{{asset('/admin-vehicle-img/'.$booking->vehicle()->first()->image_name)}}"
                                     alt="vehicle image"></td>
                            <td>{{$booking->vehicle()->first()->pivot->assigned_at}}</td>
                        </tr>
                        </tbody>
...
@section('js')
    <script>
        ...
        function initMap() {
            let uluru = {lat: pick_latitude, lng: pick_longitude};
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBgV-mkhz5pqHJrtexHQXJdV12D8nGefoI&libraries=places&callback=initMap"
            async defer></script>
@endsection
