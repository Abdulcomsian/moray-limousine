                                        ...
                                        <tr>
                                            <td style="border-collapse:collapse">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="border-collapse:collapse">
                                                            <img alt="" style="outline:none;text-decoration:none;height:auto;display:block;border:none;font-family:Roboto,arial,helvetica,sans-serif;font-size:16px;line-height:1.4em;color:rgb(255,255,255);text-decoration:none;font-weight:bold;text-align:center;width:800px;height:auto" src="./assets/img/drive.png" class="CToWUd a6T" tabindex="0">
