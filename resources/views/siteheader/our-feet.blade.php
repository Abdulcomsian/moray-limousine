    ...
    <section class="info-box parallax parallax_one">
        <div class="container">
            <div class="wrapper-content">
                ...
                <p class="contact">Jetzt Buchen {{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_PHONE_NUMBER)}}</p>
...
<section class="template-title has-over text-up">
    <div class="container">
        <h3 class="title">{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_TITLE)}}</h3>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 size-table">
                    <div class="iconbox center">
                        ...
                        <div class="iconbox-content">
                            <h3>
                                <a href="#" title="">{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL3_TITLE)}}</a>
                            </h3>
                            <p>{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADVANTAGE_COL3_DESCRIPTION)}}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12 size-table">
