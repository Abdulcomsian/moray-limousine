                        ...
                        <div class="widget-infomation">
                            <ul>
                                <li>
                                    <div class="text">
                                        <h5>Address</h5>
                                        <p>{!! \App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_ADDRESS) !!}</p>
                                    </div>
                                    <div class="icon">
                                ...
                                <li>
                                    <div class="text">
                                        <h5>Email</h5>
                                        <p>{{\App\CmsHomePage::getValueForKey(\App\Utills\Constants\AppConsts::HOME_EMAIL_ADDRESS)}}</p>
                                    </div>
                                    <div class="icon">
