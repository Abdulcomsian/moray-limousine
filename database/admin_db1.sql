...
--
-- Host: localhost:3306
-- Generation Time: Oct 13, 2021 at 09:20 AM
...
CREATE TABLE `booking` (
  ...
  `pick_address` varchar(300) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `payment_status` enum('paid','pending','canceled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `estimated_distance` double(8,2) DEFAULT NULL,
  `estimated_time` double(8,2) DEFAULT NULL,
  `pick_time` time NOT NULL,
  `pick_date` date NOT NULL,
  `booking_type` enum('distance','time','fixed') COLLATE utf8mb4_unicode_ci NOT NULL,
  `booking_status` enum('pending','approved','disapproved','canceled','completed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `orderId` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `userDetail` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `booking_city` varchar(70) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tax_amount` float DEFAULT NULL,
  `grand_total` decimal(10,0) DEFAULT NULL,
  `partner_payment_status` tinyint(4) DEFAULT '0',
  `flight_no` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sign_board` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reference_code` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `booking_billing_address` (
  ...
  `billing_address` text COLLATE latin1_german1_ci NOT NULL,
  `billing_postal_code` varchar(10) COLLATE latin1_german1_ci NOT NULL,
  `billing_city` varchar(50) COLLATE latin1_german1_ci NOT NULL,
  `billing_country` varchar(50) COLLATE latin1_german1_ci NOT NULL,
  `vat_no` varchar(15) COLLATE latin1_german1_ci DEFAULT NULL,
  `skype_id` varchar(50) COLLATE latin1_german1_ci DEFAULT NULL,
...
CREATE TABLE `booking_user` (
  ...
  `driver_status` enum('pending','accepted','rejected','approved') COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `assigned_to` enum('pending','accepted') COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `cms_faqs` (
  ...
  `title2` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `faq_question` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `cms_home_page` (
  `id` int(10) UNSIGNED NOT NULL,
  `item_name` varchar(700) COLLATE utf8mb4_unicode_ci NOT NULL,
  `item_content` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `cms_services` (
  `id` int(10) UNSIGNED NOT NULL,
  `service_title` varchar(90) COLLATE utf8mb4_unicode_ci NOT NULL,
  `service_title2` varchar(90) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `short_description` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `short_description2` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_image` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `configurations` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `map_api` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tax_rate` decimal(8,2) NOT NULL,
  `paypal_account` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_name` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `paypal_key` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `service_list_img` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_detail_img` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `our_fleet_img` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `configurations` (`id`, `map_api`, `tax_rate`, `paypal_account`, `user_name`, `paypal_key`, `created_at`, `updated_at`, `service_list_img`, `service_detail_img`, `our_fleet_img`, `cancel_hour`, `extend_hour_limit`, `extra_column`) VALUES
(1, 'AIzaSyDeHpSgm-hy0_G_NC6PynKEYgASntQIi1Y', '19.00', 'test acccount', 'test account', 'test', NULL, '2021-07-12 03:20:54', '1580564722service.png', '15800567404._Chauffeurservice_mlbby7.png', NULL, 1, 1, 2);
...
CREATE TABLE `discounts` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `status` enum('active','blocked','dis_active') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `documents` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `document_title` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `document_img` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `applied_on` enum('driver','partner','vehicle','end_user') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `drivers` (
  ...
  `whats_app` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `skype_id` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `permanent_address` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `default_location` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `additional_information` text COLLATE utf8mb4_unicode_ci,
  `vehicle_licence_no` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vehicle_licence_expiry` date DEFAULT NULL,
  `pco_licence_no` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pco_licence_expiry` date DEFAULT NULL,
  `id_card_number` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_card_image` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `endusers` (
  ...
  `whats_app` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gender` enum('male','female') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image_name` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `default_pickup_location` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `default_drop_location` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `billing_postal_code` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `billing_city` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `billing_country` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `extend_bookings` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `booking_id` bigint(20) UNSIGNED NOT NULL,
  `previous_drop_location` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `new_drop_location` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `payment_status` enum('paid','unpaid','pending') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `orderId` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `userDetail` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
...
CREATE TABLE `extraoptions` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `image_name` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `is_quantity` enum('yes','no') COLLATE utf8mb4_unicode_ci DEFAULT 'yes',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `happy_clients` (
  `id` int(10) UNSIGNED NOT NULL,
  `client_image` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `locations` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `default_location` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `location_lat` double DEFAULT NULL,
  `location_long` double DEFAULT NULL,
  `location_city` varchar(80) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `other_users` (
  ...
  `flight_information` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `banner_words` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `partners` (
  ...
  `address` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gender` enum('male','female') COLLATE utf8mb4_unicode_ci NOT NULL,
  `default_location` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `partners` (`id`, `user_id`, `skype_id`, `date_of_birth`, `phone_number`, `whats_app`, `address`, `gender`, `default_location`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `selectedoptions` (
  ...
  `option_name` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `uploadeddocuments` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `document_title` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `document_img` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `document_value` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_id` bigint(20) UNSIGNED DEFAULT NULL,
  `vehicle_id` bigint(20) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `document_status` enum('pending','approved','disapproved') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `user_type` enum('end_user','driver','partner','admin') COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone_number` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `password` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `creator_id` bigint(20) DEFAULT NULL,
  `status` enum('approved','pending','disapproved','blocked') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
CREATE TABLE `user_user` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `status` enum('approved','disapproved','active','blocked','pending') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `vehiclecategory` (
  ...
  `is_public` enum('1','') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `vehiclepricing` (
  ...
  `category_id` bigint(20) UNSIGNED NOT NULL,
  `created_by` bigint(20) UNSIGNED NOT NULL,
  `pricing_type` enum('per_km','per_hr') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `vehicles` (
  ...
  `model_no` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `vehicleCategory_id` bigint(20) UNSIGNED DEFAULT NULL,
  `standard` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `interior_color` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `exterior_color` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `length` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `engine_capacity` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `status` enum('approved','blocked','pending') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
