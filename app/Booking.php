...
class Booking extends Model
{
    ...
    protected $fillable = ['lat_pck','long_pck','lat_drop','long_drop','pick_address','drop_address'
      ,'travel_amount',
        'extra_options_amount',
        'net_amount','payment_status','estimated_distance'
       ,'estimated_time',
        'pick_time',
        'pick_date',
        'booking_type',
    ...
    public function vehicle(){
        return $this->belongsToMany(Vehicle::class,'booking_vehicle',
    ...
    public function saveSelectedOptions($options,$booking_id,$travel_amount , $form_data,$tax_amount){
        ...
        if ($options !== null or $options){
            foreach ($options as $option){
                SelectedOption::create(['booking_id' => $booking_id,
